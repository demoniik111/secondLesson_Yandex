...
document.write('<tr style="background:#C0C0C0;font:12px Arial;color:#FFFFFF"><td align=center>П</td><td align=center>В</td><td align=center>С</td><td align=center>Ч</td><td align=center>П</td><td align=center>С</td><td align=center>В</td></tr>');
...
document.write('<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:#C0C0C0" onclick="today()">Сегодня: '+addnull(sccd,sccm+1,sccy)+'</td></tr>');
...
function cs_over(e) {
	evtTgt(EvtObj(e)).style.background='#f4f4f4';
}
function cs_out(e) {
...
function f_cps(obj) {
	...
	obj.style.border='1px solid #979494';//
